...
public final class ScreenScaler {
     ...
     *
     * @param poseStack the current graphics context.
     ...
     */
    public static void scale(@NotNull PoseStack poseStack, int width, int height, int mouseX, int mouseY, @NotNull ScaleAction action) {
