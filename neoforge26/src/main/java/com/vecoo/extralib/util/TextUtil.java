...
public final class TextUtil {
    ...
    public static Component clickableMessageCommand(@NotNull String message, @NotNull String command) {
        return Component.literal(formatMessage(message).getString()).setStyle(Style.EMPTY.withClickEvent(new ClickEvent.RunCommand(command)));
    }
    ...
    public static Component clickableMessageCommand(@NotNull Component message, @NotNull String command) {
        return message.copy().setStyle(Style.EMPTY.withClickEvent(new ClickEvent.RunCommand(command)));
    }
    ...
    public static Component clickableMessageURL(@NotNull String message, @NotNull String url) {
        return Component.literal(formatMessage(message).getString()).setStyle(Style.EMPTY.withClickEvent(new ClickEvent.OpenUrl(URI.create(url))));
    }
    ...
    public static Component clickableMessageURL(@NotNull Component message, @NotNull String url) {
        return message.copy().setStyle(Style.EMPTY.withClickEvent(new ClickEvent.OpenUrl(URI.create(url))));
    }
    ...
    public static Component hoverMessageText(@NotNull String message, @NotNull String text) {
        return Component.literal(formatMessage(message).getString()).setStyle(Style.EMPTY.withHoverEvent(new HoverEvent.ShowText(formatMessage(text))));
    }
    ...
    public static Component hoverMessageText(@NotNull Component message, @NotNull String text) {
        return message.copy().setStyle(Style.EMPTY.withHoverEvent(new HoverEvent.ShowText(formatMessage(text))));
    }
}