...
public final class CommandUtil {
     ...
     */
    @NotNull
    public static SuggestionProvider<CommandSource> suggestString(@NotNull Collection<String> collection) {
        return (context, builder) -> {
     ...
     */
    @NotNull
    public static SuggestionProvider<CommandSource> suggestAmount(@NotNull Collection<Integer> collection) {
        return (context, builder) -> {
