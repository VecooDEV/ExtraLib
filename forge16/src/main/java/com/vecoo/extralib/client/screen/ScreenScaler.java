...
public final class ScreenScaler {
     ...
     *
     * @param matrixStack the current graphics context.
     ...
     */
    public static void scale(@NotNull MatrixStack matrixStack, int width, int height, int mouseX, int mouseY, @NotNull ScaleAction action) {
