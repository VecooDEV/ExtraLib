...
public final class PermissionUtil {
     ...
     */
    public static boolean hasPermission(@Nullable ICommandSender source, @NotNull String node) {
        if (source == null) {
            return false;
        }
        ...
        return hasPermission((EntityPlayerMP) entity, node);
    }
     ...
     */
    public static boolean hasPermission(@Nullable EntityPlayerMP player, @NotNull String node) {
        if (player == null) {
            return false;
        }
     ...
     */
    public static int minValue(int value, @Nullable EntityPlayerMP player, @NotNull Set<String> permissionList) {
     ...
     */
    public static int maxValue(int value, @Nullable EntityPlayerMP player, @NotNull Set<String> permissionList) {
        for (String permission : permissionList) {
            if (hasPermission(player, permission)) {
